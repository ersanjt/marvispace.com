...
const STRINGS = {
  en: {
    ...
    contactLead: 'Leather is cut in Kağıthane, Istanbul. We reply within 1–2 business days.',
    contactName: 'Name',
    contactEmail: 'Email',
    ...
    locationsTitle: 'Workshop',
    locationsLead: 'MARVISPACE sells online. Leather is made at the Istanbul Kağıthane workshop.',
    locationMap: 'Map',
  ...
  tr: {
    ...
    contactLead: 'Deri İstanbul Kağıthane’de kesilir. 1–2 iş günü içinde yanıtlarız.',
    contactName: 'Ad',
    ...
    contactOnline: 'Çevrimiçi',
    contactBack: 'Mağaza',
    contactNavLine: 'İstanbul',
    ...
    locationsTitle: 'Atölye',
    locationsLead: 'MARVISPACE online satıştır. Deri İstanbul Kağıthane atölyesinde üretilir.',
    locationMap: 'Harita',
